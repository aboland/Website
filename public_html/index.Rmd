...
<!-- this is in the in_header.html file
...
I am currently lecturing [Introduction to Data Analytics](https://sisweb.ucd.ie/usis/!W_HU_MENU.P_PUBLISH?p_tag=MODULE&MODULE=STAT40720&MAJR=F084) which forms part of the [MSc in Data Analytics](https://sisweb.ucd.ie/usis/!W_HU_MENU.P_PUBLISH?p_tag=PROG&MAJR=F084) in the [UCD School of Mathematics and Statistics](https://www.ucd.ie/mathstat/).

In the first half of 2019 I delivered lectures for the [Data Analysis for Decision Makers](https://sisweb.ucd.ie/usis/!W_HU_MENU.P_PUBLISH?p_tag=QMOD&MAJR=BSW1&MODULE=MIS10090) module in the [UCD Lochlann Quinn School of Buisness](http://www.ucd.ie/quinn/).  
