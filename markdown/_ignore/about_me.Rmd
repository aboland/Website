...
<!-- <div class = "row"> -->
<!-- <div class = "col-md-2"> -->
<!-- <p><img src="images/profile_2018.jpg" width="100px" height="20px" /></p> -->
<!-- </div> -->
<!-- <div class = "col-md-10"> -->
<!-- I currently work as a Senior Data Scientist with [Edge by Ascential](https://www.ascentialedge.com/) a leading firm in ecommerce insights and analytics.<br /> My work focuses on researching and implementing statistical and machine learning techniques in order to improve and automate processes within the company. -->

<!-- I'm also an occasional lecturer in the [UCD School of Mathematics and Statistics](https://www.ucd.ie/mathstat/), where I currently lecture Introduction to Data Analytics which forms part of the Masters in Data Analytics. -->
<!-- </div> -->
<!-- </div> -->
...
In October 2019 I was invited to speak at the inagurual Young-Irish Statistical Association meeting.   
- **[EARL Boston 2017](/docs/EARL2017.pdf)**  
I presented the use of the Plumber package at the Enterprise Application of the R Language in November 2017.

See more presentaions and posters in the Documents section of the navbar above.
